...
import { type TWarehouseStatus, WarehouseStatusItems } from '@/enums/modules/warehouse/WarehouseStatus.enum'
...
async function useFetch (): Promise<void> {
  const items = WarehouseStatusItems
...
watch(innerModel, (val: TBaseModel | null): void => {
  model.value = val?.id ? val.id as TWarehouseStatus : undefined
