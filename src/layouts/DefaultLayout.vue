<template>
  <div
    ...
    <div
      ...
      <header class="md:hidden flex items-center h-14 px-4 bg-white border-b border-[--p-gray-5] shrink-0">
        <button
          class="flex items-center justify-center size-9 rounded hover:bg-surface-100 transition-colors"
          @click="toggle()">
          <Icon
