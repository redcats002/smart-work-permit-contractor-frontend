...
const theme = ref<DividerPassThroughOptions>({
  root: `p-horizontal:flex p-horizontal:w-full p-horizontal:relative p-horizontal:items-center 
        p-horizontal:my-4 p-horizontal:mx-0p-horizontal:py-0 p-horizontal:px-4
        ...
        p-horizontal:before:border-t p-horizontal:before:border-primary-500 dark:p-horizontal:before:border-primary-700
        p-vertical:min-h-full p-vertical:flex p-vertical:relative p-vertical:justify-center
        p-vertical:my-0 p-vertical:mx-4 p-vertical:py-2 p-vertical:px-0
