...
import { readyForApartmentAppraisal } from '../../schema/pre-asset/apartment.schema.ts'
import { readyForAppraisal as readyForLandAppraisal } from '../../schema/pre-asset/land.schema.ts'
import { readyForAppraisal as readyForVehicleAppraisal } from '../../schema/pre-asset/vehicle.schema.ts'
