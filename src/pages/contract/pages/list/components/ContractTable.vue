...
const columns = ref<IColumn<IContractList>[]>([
  ...
  { field: 'contractLoanType', header: 'ประเภทเงินกู้', align: 'left', style: { width: '160px', minWidth: '160px' }, bodyStyle: { whiteSpace: 'normal', wordBreak: 'break-word' }, value: (e: IContractList): string => e.contractLoanType?.name || 'ไม่ระบุ' },
  { field: 'branch', header: 'สาขา', align: 'left', style: { width: '160px', minWidth: '160px' }, bodyStyle: { whiteSpace: 'normal', wordBreak: 'break-word' }, value: (e: IContractList): string => e?.branch?.name || 'ไม่ระบุ' },
