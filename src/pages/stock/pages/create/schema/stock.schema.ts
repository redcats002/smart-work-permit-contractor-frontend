...
export function useFormInitialValues (): StockFormValues {
  return {
    assetNo: '', // เช่น AS-00001
    contractNo: '', // เช่น LC-00001
    receivedDate: '', // เช่น 12/3/67
    titleName: '', // เช่น นาย/นาง/นางสาว
    firstName: '',
    lastName: '',
    category: '', // เช่น อสังหาริมทรัพย์ - ที่ดิน
    warehouse: '', // เช่น สำนักงานใหญ่
    storageLocation: '', // เช่น BR001-31-13
    status: StockStatusEnum.ACTIVE // ปรับตามสถานะเริ่มต้นที่ระบบต้องการ
  }
}
