<template>
  <BaseContainer>
    <template #topright>
      <ProfileDetailMenuAction @edit="emits('edit')" />
    </template>
...
import ProfileDetailMenuAction from './ProfileDetailMenuAction.vue'
...
const items = computed((): IDisplayList[] => {
  return [
    ...
    { label: 'เลขที่พนักงาน', key: 'id', value: props.data?.idNo },
