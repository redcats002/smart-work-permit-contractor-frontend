 ...
 * picker asks for the full active set on the chosen plan in one page, same `limit: 9999`
 * convention `AreaPicker`/`PinPicker` both use rather than relying on the server's default page
 * size of 10.
 */
