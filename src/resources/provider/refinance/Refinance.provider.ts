...
export interface IRefinanceProvider {
  ...
  ): Promise<TGetRefinanceResponse>
  createRefinance (
    contractId: TBaseParamsId,
    payload: IRefinancePayload
  ): Promise<TCreateRefinanceResponse>
  makeAContract (
    contractId: TBaseParamsId,
    payload: IRefinanceMakeAContractPayload
  ): Promise<TMakeAContractResponse>
}
